...
/* TODO
  ...
  - As alterações do estados da lista e total deverá ocorrer no useEffect.
   ...
   Para resolver o problema em que a listagem atualiza descontroladamente e
   exponencialmente, tirei o list do array de dependências do React. Adicionei
   o state "count1" na lista de dependências do useEffect para considerá-lo
   também na contagem. Tudo isso obedencendo os critérios pré-estabelecidos.
   Além disso, o componente foi tipado para boa manutenção do código e legibilidade.
*/

export const Desafio4: React.FC = () => {
  ...
  useEffect(() => {
    const totalCount: number = count1 + count2 + count3;
    setTotal(totalCount);
